(function ($) {
	...
	Portlet.prototype.refresh = function (refresh) {
		...
		if (refresh) {
			...
			var elem = "";
			var style = `background: url("${this.options.path}") no-repeat top left;`;
			if (this.options.progress === "custom") {
				elem += `<div class='progress-circle-indeterminate' style='width: 50px; height: 50px; background-size: 100% auto; margin: 0 auto; ${
					style}'></div>`;
			} else if (this.options.progress === "circle") {
				elem += `<div class="progress-circle-indeterminate progress-circle-${this.options.progressColor}"></div>`;
			} else if (this.options.progress === "circle-custom") {
				elem += `<div class="progress-circle-indeterminate progress-circle-${this.options.progressColor
					}" style="width: 60px; height: 60px; margin-left: -30px; margin-top: -50px"><br /><br /><img src="${this.options.path
					}" style="width: 256px; margin-left: -95px; margin-top: 15px" /></div>`;
