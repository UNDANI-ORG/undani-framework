...
(function ($) {
    ...
    Notification.prototype.show = function () {
        var n = this;
        n.wrapper.prepend(n.notification);
        n.options.onShown();
        if (n.options.timeout != 0) {
            setTimeout(function (e) {
                n.notification.fadeOut("slow", function () {
                    $(this).remove();
                    n.options.onClosed();
                });
            }.bind(n), n.options.timeout);
        }
    };
...
(function ($) {
    ...
    Sidebar.prototype.togglePinSidebar = function (toggle) {
        if (toggle == 'hide') {
            ...
            $('#anclamenu').removeClass('fa-rotate-90');
            setCookie("undanianclamenu", true, 365);
        } else if (toggle == 'show') {
            this.$body.addClass('menu-pin');
            $('#anclamenu').addClass('fa-rotate-90');
            setCookie("undanianclamenu", false, 365);
        } else {
